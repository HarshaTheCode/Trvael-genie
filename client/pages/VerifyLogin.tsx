...
import { Compass, CheckCircle, XCircle, Loader2, ArrowLeft } from 'lucide-react';
        ...
        <Card className="shadow-xl">
          <CardHeader>
            <CardTitle className="text-center flex items-center justify-center gap-2">
              {status === 'loading' && <Loader2 className="h-5 w-5 animate-spin text-orange-600" />}
            ...
            <div className="text-center space-y-4">
              ...
              {status === 'success' && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <p className="text-green-800 font-medium">Welcome to TravelGenie!</p>
