...
const destinationsData: Destination[] = [
  {
    ...
    transport_summary: 'Well connected by air, rail, and road. Local transport via auto-rickshaws, taxis, and buses.',
  ...
  },
  {
    ...
    transport_summary: 'Airport and railway station available. Boat rides on lakes, auto-rickshaws for city travel.',
  ...
  },
  {
    ...
    transport_summary: 'Airport at Dabolim. Train connectivity. Bikes, taxis, and buses for local transport.',
  ...
  },
  {
    ...
    transport_summary: 'Airport and major railway junction. Auto-rickshaws, cycle rickshaws, and boats.',
  ...
  },
  {
    ...
    transport_summary: 'Well connected by air, rail, and road. Auto-rickshaws and taxis available.',
  ...
  },
  {
    ...
    best_time: 'October to March (winter season)',
    transport_summary: 'Major transport hub with metro, buses, auto-rickshaws, and taxis.',
  ...
  },
  {
    ...
    transport_summary: 'Major airport and railway hub. Local trains, buses, taxis, and auto-rickshaws.',
...
• Budget guide: Low (₹3000-8000/day), Medium (₹8000-20000/day), High (₹20000+/day)`;
  ...
  static searchDestinations(query: string): Destination[] {
    ...
    return destinationsData.filter(dest => 
      ...
      dest.top_attractions.some(attr => attr.toLowerCase().includes(normalizedQuery))
    );
  }
